...
OWASP beschreibt Static Application Security Testing (SAST) als Werkzeuge, die *"source code or compiled versions of code [analysis], to help find security flaws"* ([OWASP -- Source Code Analysis Tools](https://owasp.org/www-community/Source_Code_Analysis_Tools)). 
